<div id="wrap" class="<?php if ($site_title_position_classes): ?><?php print $site_title_position_classes; ?><?php endif; ?><?php if ($subsite_site_name_text) { echo ' subsite';} ?>"> <a href="#content" class="element-invisible element-focusable"><?php print t('Skip to content'); ?></a>
  <?php if ($main_menu): ?>
    ...
    <div class="container">
      <div class="row">
        <div class="<?php if ($page['search_box']): print 'span8'; else: print 'span12'; endif; ?>">
          ...
          <div id="name-and-slogan"  class="<?php if (isset($logo)) { print ('with-logo'); } ?>">
        ...
        <div id="content" class="mc-content <?php if (($page['sidebar_first']) && ($page['sidebar_second'])): print 'span6'; elseif (($page['sidebar_first']) || ($page['sidebar_second'])): print 'span9'; else: print 'span12'; endif; ?>">
          <div id="content-wrapper" class="content-wrapper">
            <div id="content-head" class="row-fluid content-head">
              ...
              <?php if ($title && !$subsite_is_front): // checking for subsite and then check if "home" of subsite ?>
              <h1 class="title" id="page-title"><?php print $title; ?> </h1>
              <?php endif; // end subsite title check ?>
