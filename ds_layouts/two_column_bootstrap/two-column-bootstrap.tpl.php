...
/**
 * @file
 * Display Suite Two Column Bootstrap template.
 *
 * Available variables:
 *
 * Layout:
...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> clearfix">
  ...
  <?php endif; ?>
    ...
    <<?php print $left_wrapper; ?> class="clear-row span6 ds-left<?php print $left_classes; ?>">
      <?php print $left; ?>
    </<?php print $left_wrapper; ?>>

    <<?php print $right_wrapper; ?> class="span6 ds-right<?php print $right_classes; ?>">
      <?php print $right; ?>
